...
A system of equations is called \emph{inconsistent} when there is no solution for this system of equations, and it is called \emph{consistent} when there is at least one solution for it.
```
...
\end{align*}
This matrix is called the \textbf{augmented matrix} of the system.
