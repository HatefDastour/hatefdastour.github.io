...
- [An optimal 13-point finite difference scheme for a 2D Helmholtz equation with a perfectly matched layer boundary condition](https://doi.org/10.1007/s11075-020-00926-5){:target="_blank"}
...
- [A stable numerical solution of a class of semi-linear Cauchy problems](https://contacts.ucalgary.ca/info/math/files/info/unitis/publications/1-6943191/Article_03.pdf){:target="_blank"}