...
- To update a package, use ```python -m pip install -U package```. For example, to update *matplotlib* we can use <br/>
```python -m pip install -U matplotlib```


## Installing R packages
See this link for [details](https://docs.anaconda.com/anaconda/packages/r-language-pkg-docs/#targetText=You%20can%20install%20any%20of,%2Dc%20r%20package%2Dname%20.&targetText=Replace%20package%2Dname%20with%20the,%2Dc%20r%20r%2Dacepack%20.).
